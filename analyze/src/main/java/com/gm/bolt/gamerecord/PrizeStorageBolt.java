 ...
 *
 */
public class PrizeStorageBolt extends BaseRichBolt{
	...
	public PrizeStorageBolt(String url, String collectionName) {
    ...
    public void execute(Tuple tuple) {
        ...
        try{
        	MongoMapper mapper = new SimpleMongoUpdateMapper().withFields("memberName","multiple","betAmount","gainAmount","date","key");
